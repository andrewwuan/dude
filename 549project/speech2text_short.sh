...
#echo "Recording..."
arecord -D "plughw:1,0" -d 2 -q -f cd -t wav -r 16000 -c 1 dude.wav
...
wget -q -U "Mozilla/5.0" --post-file dude.flac --header "Content-Type: audio/x-flac; rate=16000" -O - "http://www.google.com/speech-api/v2/recognize?lang=en-us&client=chromium&key=AIzaSyB9p1nB1JodqUUHWuhBs7ls3RmPYEjsDSE" | cut -d\" -f8 > stt.txt
